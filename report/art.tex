...
value insertion and removal in \Cref{sec:algorithms}.
...
in \Cref{sec:vertical-compression,sec:horizontal-compression}.
...
\begin{wrapfigure}{r}{0.51\textwidth}
  \begin{minted}[numbers=right,frame=single,fontsize=\scriptsize]{c++}
