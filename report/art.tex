...
both its competitors in the lookup and insertion microbenchmarks. In contrast, 
both RBT and HT outperform ART in the deletion microbenchmark.
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot coordinates {(ART,3155911.8) (RBT,2471577.4) (HT,5501451.5)};
      \end{axis}
    \end{tikzpicture}
    \caption{Lookup}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot coordinates {(ART,2132464.3) (RBT,2010422.3) (HT,3618333.0)};
      \end{axis}
    \end{tikzpicture}
    \caption{Insertion}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot coordinates {(ART,1292128.7) (RBT,1718313.7) (HT,3072309.1)};
      \end{axis}
    \end{tikzpicture}
    \caption{Deletion}
...
``\texttt{/a/c}'', etc.). The dataset is based on DELL's website [?].
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot coordinates {(ART,560488.0) (RBT,481390.2) (HT,982706.9)};
    \end{axis}
  \end{tikzpicture}
